...
### Set up how you get data from completed forms

By default, data from each completed form is sent in the body of an email - to the address you nominate when creating the form. You can opt to:

- get data from each completed form in a CSV or JSON file, attached to the email - as well as in the body of the email
- get data from completed forms in an AWS S3 bucket, instead of by email

[Read more about options for processing completed form submissions](https://www.forms.service.gov.uk/processing-completed-form-submissions).
...
You can make a Welsh version of a form. People will be able to switch between English and Welsh as they go through the form.
...
Use simple metrics to see how many forms were submitted and the completion rate by day.

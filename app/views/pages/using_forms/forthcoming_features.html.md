...
- Collating data from multiple completed forms into one file
- Making additional improvements to Welsh language forms
- Sending a copy of the answers a person has provided to their email address
- Sending email notifications to organisation admins when someone in their organisation makes a form live or creates a new draft in an active group

## Later in 2026

- Further improvements for managing users and forms in an organisation
...
- Opening up use of GOV.UK Forms to local government
...
- Allowing people to fill in forms using information they've already provided to government
...
If you have any feedback about existing features, or need a feature that isn’t listed here, you can [contact us](<%= support_path %>) to let us know.
